...
import resnet_architecture as model               
...
def train():
	...
	logits,out_probs=model.network(X,dropout_keep_prob=dropout_keep_prob,label_cnt=label_cnt,type_=FLAGS.type_,training=training)
